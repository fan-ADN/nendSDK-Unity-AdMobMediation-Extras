...
public class GoogleMobileAdsDemoScript : MonoBehaviour
{
...
#if UNITY_ANDROID
		string appId = "ca-app-pub-6341465377922317/8350661386";
#elif UNITY_IPHONE
		string appId = "ca-app-pub-6341465377922317/6607962583";
#else
	...
	private AdRequest CreateMediationAdRequest()
	{
		NendNormalMediationExtras extra = new NendNormalMediationExtras ();
		extra.InterstitialType = NendNormalMediationExtras.interstitialTypeVideo;
...
//	}
    ...
    private void RequestInterstitial()
    {
        ...
        string adUnitId = "unused";
#elif UNITY_ANDROID
		string adUnitId = "ca-app-pub-6341465377922317/1532196183";
#elif UNITY_IPHONE
		string adUnitId = "ca-app-pub-6341465377922317/4776913416";
#else
        string adUnitId = "unexpected_platform";
#endif
		...
		this.interstitial.LoadAd(this.CreateMediationAdRequest());
    }
    ...
    private void RequestRewardBasedVideo()
    {
        ...
        string adUnitId = "unused";
#elif UNITY_ANDROID
        string adUnitId = "ca-app-pub-6341465377922317/8350661386";
#elif UNITY_IPHONE
        string adUnitId = "ca-app-pub-6341465377922317/6607962583";
#else
        string adUnitId = "unexpected_platform";
#endif
